...
- [PUIUX Pilot](https://github.com/PUIUX-Cloud/puiux-pilot) by [PUIUX](https://github.com/PUIUX-Co) - Auto-configures Claude Code for any project. Scans your codebase (95+ project types), selects relevant hooks from 28+ across 6 event types, configures MCPs based on dependencies, and scores quality (0-100, A-F). Features dry-run default, atomic writes, backup + rollback, clean eject, and cross-tool config translation (CLAUDE.md ↔ .cursorrules ↔ .windsurfrules ↔ copilot).
